...
var _spreadGrid = require("./spreadGrid");
[
    ...document.querySelectorAll(".grid")
].forEach((grid)=>new (0, _spreadGrid.SpreadGrid)(grid));
// Preload images
(0, _utils.preloadImages)(".grid__item-img").then((_)=>document.body.classList.remove("loading"));

},{"./utils":"72Dku","./spreadGrid":"fyl9m"}],"72Dku":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "map", ()=>map);
parcelHelpers.export(exports, "preloadImages", ()=>preloadImages);
parcelHelpers.export(exports, "getTranslationDistance", ()=>getTranslationDistance);
parcelHelpers.export(exports, "getDistance", ()=>getDistance);
const imagesLoaded = require("d75c68d57e2dc17e");
/**
...
},{"d75c68d57e2dc17e":"aYzyZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aYzyZ":[function(require,module,exports) {
/*!
 * imagesLoaded v5.0.0
 ...
 */ (function(window1, factory) {
    ...
    module.exports = factory(window1, require("7e435163d45a0dc7"));
    else // browser global
...
},{"7e435163d45a0dc7":"7rCHo"}],"7rCHo":[function(require,module,exports) {
/**
 * EvEmitter v2.1.1
 * Lil' event emitter
 * MIT License
...
},{}],"fyl9m":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 * Class representing a Spread Grid
 */ parcelHelpers.export(exports, "SpreadGrid", ()=>SpreadGrid);
var _utils = require("./utils");
...
class SpreadGrid {
	 ...
	 */ constructor(DOM_el){
        ...
        this.items = [];
        this.DOM.items.forEach((item)=>this.items.push(new (0, _item.Item)(item)));
	 ...
	 * Initialize events.
	 */ initEvents() {
        for (const item of this.items)item.DOM.el.addEventListener("click", ()=>this.expand(item));
    }
    /**
	 ...
	 */ expand(item) {
        ...
        }).addLabel("start", 0).addLabel("end", this.options.duration).set(item.DOM.el, {
            zIndex: this.expanded === -1 ? 1 : 999
        }, this.expanded === -1 ? "end" : "start");
        if (this.options.skew) this.tl.to(item.DOM.el, {
        ...
        if (this.previousExpanded !== -1) {
            ...
            ;
            this.tl.set(prevItem.DOM.el, {
                zIndex: 1,
                delay: delay
            }, "start").to(prevItem.DOM.el, {
                scale: 1,
                x: 0,
                y: 0,
                rotation: 0,
        ...
        for (let otherItem of filteredArray){
            const { x , y  } = this.expanded === -1 ? {
                x: 0,
                y: 0
            } : (0, _utils.getTranslationDistance)(otherItem.DOM.el, item.DOM.el, this.options.spread, this.options.maxDistance);
            const delay1 = 0 //this.expanded === -1 ? 0 : map(getDistance(otherItem.DOM.el, item.DOM.el), 0, 1500, 0, 0.2);
            ;
            const zIndex = Math.round((0, _utils.map)((0, _utils.getDistance)(otherItem.DOM.el, item.DOM.el), 0, 100000, 998, 1));
            const rotationInterval = this.options.maxRotation ? Math.max(Math.round((0, _utils.map)((0, _utils.getDistance)(otherItem.DOM.el, item.DOM.el), 0, 500, this.options.maxRotation, 0)), 0) : 0;
            this.tl.set(otherItem.DOM.el, {
                zIndex: this.expanded === -1 ? 1 : zIndex,
                delay: delay1
            }, this.expanded === -1 ? "end" : "start").to(otherItem.DOM.el, {
                x: x,
                y: y,
                rotation: this.expanded === -1 ? 0 : (0, _gsap.gsap).utils.random(rotationInterval * -1, rotationInterval),
                delay: delay1
            }, "start");
        }
    }
...
},{"./utils":"72Dku","gsap":"fPSuC","./item":"8aqVM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire0f1e")
